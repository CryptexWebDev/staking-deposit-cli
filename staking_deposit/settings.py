...
# Dorol setting
DorolSetting = BaseChainSetting(
    NETWORK_NAME=DOROL, GENESIS_FORK_VERSION=bytes.fromhex('20000089'),
    GENESIS_VALIDATORS_ROOT=bytes.fromhex('b131006b3dcaa0537531b9625fa8e8ab6f47001cd2bb226415c2917eec720047'))
# Mainnet setting
...
def get_chain_setting(chain_name: str = DOROL) -> BaseChainSetting:
